...
class TestEventPredictions(unittest.TestCase):
    """ EventPredictions unit test stubs """
    ...
    def testEventPredictions(self):
        """
        Test EventPredictions
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = net.thefletcher.tbaapi.v3client.models.event_predictions.EventPredictions()
        pass
