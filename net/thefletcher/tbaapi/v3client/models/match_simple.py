...
class MatchSimple(object):
    ...
    def __init__(self, key=None, comp_level=None, set_number=None, match_number=None, alliances=None, winning_alliance=None, event_key=None, time=None, predicted_time=None, actual_time=None):
        """
        MatchSimple - a model defined in Swagger
        """
