...
class TeamEventStatus(object):
    ...
    def __init__(self, qual=None, alliance=None, playoff=None, alliance_status_str=None, playoff_status_str=None, overall_status_str=None, next_match_key=None, last_match_key=None):
        """
